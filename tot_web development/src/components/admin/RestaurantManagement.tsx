  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-primary-900">Restaurant Management</h1>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50">
                {['Name', 'Status', 'Revenue', 'Orders', 'Rating', 'Last Payment'].map((header) => (
            <th
                key={header}
                onClick={() => {
                ...
                header.toLowerCase().replace(' ', '') !== 'actions' && "cursor-pointer hover:bg-gray-100"
                )}
            >
